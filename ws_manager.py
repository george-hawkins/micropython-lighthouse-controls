...
class WsManager:
    ...
    def _on_data_sent(self, xas_cli, _):
        self._add_ws_client(xas_cli._socket)
        xas_cli._socket = DummySocket()
        xas_cli.Close()
    ...
    def upgrade_connection(self, request):
        ...
        request.Response.SwitchingProtocols("websocket", self._on_data_sent)
        return True
